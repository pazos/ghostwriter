...
#ifndef HOEDOWNEXPORTER_H
#define HOEDOWNEXPORTER_H

#include "Exporter.h"

/**
 * Exports Markdown text to HTML via the built-in Hoedown processor.
 */
class HoedownExporter : public Exporter
{
    public:
        /**
         * Constructor.
